...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 20, 2020 at 05:45 PM
...
INSERT INTO `tbl_custom` (`no_custom`, `no_order`, `no_brg`, `nm_brg`, `harga`, `biaya`, `lebar_bahu`, `lingkar_dada`, `pjg_tgn`, `lingkar_lengan`, `lingkar_pinggang`, `lingkar_pinggul`, `panjang`, `catatan`) VALUES
(8, 'ORD001', 'BRG016', 'Hem Aquino', 425000, 100000, 21, 12, 33, 44, 34, 43, 12, 'ghghghghg'),
(9, 'ORD003', 'BRG003', 'Blouse Arasya', 425000, 100000, 21, 43, 11, 44, 11, 43, 34, 'bnbnbnnb'),
(10, 'ORD003', 'BRG006', 'Blouse Leora', 425000, 100000, 43, 12, 0, 0, 0, 0, 12, 'uuyuuyu'),
(11, 'ORD005', 'BRG013', 'Hem Zeano', 375000, 100000, 34, 12, 11, 21, 11, 43, 12, 'hghhghghg');
...
INSERT INTO `tbl_keranjang` (`no_keranjang`, `no_member`, `no_brg`, `no_brg_detail`, `jml_beli`) VALUES
(83, 'MBR001', 'BRG001', 'BDL001', 1),
(84, 'MBR001', 'BRG006', 'BDL021', 3);
...
('ORD001', '2020-06-22', '2020-06-25', '2020-06-22', 'MBR001', 'Hem Aquino - (Kustom), ', 525000, 325000, 1, 10, 20000, 597500, 'Sulawesi Selatan', 'Makassar', 'jl. a. yani ', 71134, 'man-4.jpg', 'aset/file/Invoice/ORD001-20200622234567.pdf', '', 'Dalam Pengiriman', '120040042107018', 'JNE'),
('ORD002', '2020-06-22', '2020-06-25', '2020-06-23', 'MBR001', 'Hem Octano - XL (1), Hem Zeano - M (1), Hem Zeano - L (2), ', 1387500, 887500, 4, 10, 20000, 1546250, 'Kalimantan Selatan', 'Makassar', 'jl. a. yani km.4', 71134, 'product-1.jpg', 'product-7.jpg', '', 'Selesai', '120040042546678', 'JNE'),
('ORD003', '2020-06-22', '2020-06-25', '2020-06-24', 'MBR002', 'Blouse Arasya - (Kustom), Blouse Leora - (Kustom), ', 1050000, 750000, 2, 10, 20000, 1175000, 'Kalimantan Selatan', 'Banjarmasin', 'jl. a. yani km.4', 71134, 'product-1.jpg', 'product-1.jpg', '', 'Selesai', '120040042879965', 'JNE'),
('ORD004', '2020-06-25', '2020-06-28', '0000-00-00', 'MBR002', 'Tunik Aurelia - S (2), Tunik Brigita - S (1), ', 1287850, 0, 3, 0, 0, 0, 'Kalimantan Selatan', 'Banjarmasin', 'jl. a. yani km.4', 78865, '', '', '', '', '', ''),
('ORD005', '2020-06-24', '2020-06-27', '0000-00-00', 'MBR001', 'Hem Zeano - (Kustom), ', 475000, 0, 1, 0, 0, 0, 'Sulawesi Selatan', 'Makassar', 'jl. a. yani ', 78865, '', '', '', 'Di Proses', '', '');
...
INSERT INTO `tbl_order_detail` (`order_detail_id`, `no_order`, `no_brg`, `nm_brg`, `ukuran`, `harga`, `jml_order`, `diskon`, `harga_akhir`, `jumlah_harga`) VALUES
(90, 'ORD002', 'BRG015', 'Hem Octano', 'XL', 375000, 1, 30, 262500, 262500),
(91, 'ORD002', 'BRG013', 'Hem Zeano', 'M', 375000, 1, 0, 375000, 375000),
(92, 'ORD002', 'BRG013', 'Hem Zeano', 'L', 375000, 2, 0, 375000, 375000),
(93, 'ORD004', 'BRG001', 'Tunik Aurelia', 'S', 599000, 2, 30, 419300, 419300),
(94, 'ORD004', 'BRG008', 'Tunik Brigita', 'S', 599000, 1, 25, 449250, 449250);
...
--
ALTER TABLE `tbl_keranjang`
  MODIFY `no_keranjang` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=85;

--
-- AUTO_INCREMENT for table `tbl_order_detail`
--
ALTER TABLE `tbl_order_detail`
  MODIFY `order_detail_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=95;
