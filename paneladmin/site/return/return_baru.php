...
$upFile = $dirUpload.$namaFile;
		...
		"INSERT INTO tbl_return(no_return, nm_brg, tgl_msk, ktgri_brg, ukuran, harga, diskon, stok, deskripsi, gambar) VALUES('$no_return','$nm_brg', '$tgl_msk', '$ktgri_brg', '$ukuran', '$harga', '$diskon', '$stok', '$deskripsi', '$$upFile')") or die( mysqli_error($koneksi) );; 
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark"> Tambah Data Master Retur Baru</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
...
<form method="post" action="" class="form-horizontal" role="form" enctype="multipart/form-data">
	<div class="form-group row">
		<label for="no_return" class="col-sm-2 col-form-label">No. Barang</label>
		<div class="col-sm-4">
			<input type="text" readonly="" value="<?php echo $newID; ?>" class="form-control" id="no_return" name="no_return" placeholder="No. Barang" required>
		</div>
	</div>
	<div class="form-group row">
	...
	<div class="form-group row">
		<div class="col-sm-4">
			...
			<a href="./admin.php?hlm=return" class="btn btn-danger">Batal</a>
		</div>
	</div>
</form>
</div>
