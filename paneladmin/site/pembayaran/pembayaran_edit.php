...
$upFile = $dirUpload.$namaFile;
		...
		$sql = mysqli_query($koneksi, "UPDATE tbl_order SET nm_brg='$nm_brg', tgl_msk='$tgl_msk', ktgri_brg='$ktgri_brg', ukuran='$ukuran', harga='$harga', diskon='$diskon', harga_akhir='$harga_akhir', stok='$stok', deskripsi='$deskripsi', gambar='$upFile' WHERE no_order='$no_order'");
...
<div class="card-body">
	...
	<div class="form-group row">
		...
		<div class="col-sm-4">
			<input type="text" class="form-control" id="nm_brg" name="nm_brg" value="<?php echo $row['nm_brg']; ?>" placeholder="Nama order" required>
		</div>
	</div>
	<div class="form-group row">
	...
	<div class="form-group row">
		...
		<div class="col-sm-4">
			...
			<a class="text-sm">* Diskon berupa persenan dari harga order</a>
		</div>
	</div>
	</br>
	<div class="form-group row">
