...
if( empty( $_SESSION['id_user'] ) ){
	...
	die();
      ...
      if(isset($_REQUEST['submit'])){
		 ...
		 $sql = mysqli_query($koneksi, "SELECT * FROM tbl_supplier, tbl_perkara WHERE alamat BETWEEN '$tgl1' AND '$tgl2' AND tbl_supplier.nm_supplier=tbl_perkara.nm_supplier");
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
		  <a href="./admin.php?hlm=supplier" id="tombol" class="btn btn-info pull-left noprint"><i class="fas fa-undo nav-icon"></i>Kembali</a>
