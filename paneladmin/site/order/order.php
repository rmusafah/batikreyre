	...
	if( isset( $_REQUEST['aksi'] )){
		...
		switch($aksi){
			...
			case 'invoice':
				...
				break;
			case 'upload_invoice':
				include 'order_invoice_upload.php';
				break;
			case 'kwitansi':
...
<tr>
 ...
 <td>
	...
	<a href="<?php echo $row['invoice']; ?>" target="_blank">Invoice</a>/
 ...
 <td>
		...
		<a href="?hlm=order&aksi=upload_invoice&no_order=<?php echo $row['no_order']; ?>" target="_blank" class="btn btn-success btn-xs"><i class="fas fa-file nav-icon"></i>Invoice</a>
...
if(mysqli_num_rows($sql) < 1){
 echo '<td colspan="13"><center><p class="add">Tidak ada data untuk ditampilkan. <u></u> </p></center></td></tr>';}
?>
<?php }} ?>
	</tbody>
</table>
