...
$newID = $char . sprintf("%03s", $noUrut);
	...
	if( isset( $_REQUEST['submit'] )){
		...
		"INSERT INTO tbl_order(no_member, nm_dpn, nm_blkg, jk, provinsi, kota, alamat, kode_pos, telp, email, password) VALUES('$no_member', '$nm_dpn', '$nm_blkg', '$jk', '$provinsi', '$kota', '$alamat', '$kode_pos', '$telp', '$email', '$password')") or die( mysqli_error($koneksi) );; 
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="row">
							...
							<div class="col-lg-12">
                                <input type="hidden" id="no_member" name="no_member">
                            </div>
                            <div class="col-lg-6">
                            ...
                            <div class="col-lg-12">
                                <label for="cun-name">Provinsi</label>
                            ...
                            <div class="col-lg-6">
                                <label for="town">Telp.<span>*</span></label>
                        ...
                        <div class="place-order">
							...
							if (isset($_SESSION['items'])) {
                                ...
                                <ul class="order-table">
                                    ...
                                    <li class="fw-normal"><?php echo $data['nm_brg']; ?> x <?php echo number_format($val); ?><span><?php echo number_format($jumlah_harga); ?></span></li>
                                    <li class="fw-normal">Subtotal <span>Rp.<?php echo number_format($data['harga'],2,",",".");?></span></li>
                                    <li class="total-price">Total <span>Rp. <?php echo abs((int)$_GET['total']); ?>,-</span></li>
                                </ul>
								<?php
